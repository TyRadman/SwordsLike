...
ASwordslikeCharacter::ASwordslikeCharacter()
{
	...
	TargetLockerComponent = CreateDefaultSubobject<UTargetLockerComponent>(TEXT("Target Locker")); 
	LockIndicatorWidget = CreateDefaultSubobject<ULockWidgetController>(TEXT("Lock Indicator"));
	
	// if(TargetLockerComponent && LockIndicatorWidget)
	// {
	// 	TargetLockerComponent->SetLockIndicatorWidget(LockIndicatorWidget);
	// }
}
